...
/**
 * Generuje UTM odkazy na článek pro jednotlivé reklamní/distribuční kanály.
 *
 * Na rozdíl od CTA URL (viz functions.php popi_clanky_cta_url) tyto odkazy
 * vedou NA samotný článek — používají se jako cílová URL v Google Ads, Sklik,
 * Meta Ads apod., tedy tam, kam se vkládá odkaz na inzerát/příspěvek.
 */
class Popi_Clanky_Utm_Generator {
	...
	const UTM_KAMPAN_FIELD_KEY = 'field_clanky_utm_kampan';
	...
	public static function add_meta_box(): void {
		add_meta_box(
			'popi_clanky_utm_generator',
			'UTM odkazy pro kampaně (popi-clanky-blog)',
	...
	/**
	 * Vrátí trvalou adresu článku — pro koncepty dopočítá adresu ze slugu,
	...
	/**
	 * Vrátí UTM odkazy na článek pro všechny kanály.
	 *
	...
	public static function render_meta_box( WP_Post $post ): void {
		$base_url = self::permalink_for( $post );
		if ( ! $base_url ) {
			echo '<p>Nejdřív ulož článek (vyplň název a klikni na Uložit jako koncept) — odkazy se generují podle URL adresy stránky.</p>';
			return;
		}
		...
		<div class="popi-utm-generator-wrap">
			...
			<p>
				...
				<input type="text" id="popi_utm_campaign_input" value="<?php echo esc_attr( $campaign ); ?>" class="regular-text" placeholder="např. letni-vylet-2026">
				<span class="description" style="display:block;margin-top:4px;">Změna se promítne do ACF pole <em>UTM campaign</em> (sekce CTA & Tracking) a uloží se při uložení článku.</span>
			</p>
