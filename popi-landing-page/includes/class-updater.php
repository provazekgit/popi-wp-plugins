 ...
 *
 * Update server musí na URL `POPI_LANDING_UPDATE_URL` vracet JSON:
 * {
 *   "version": "1.0.1",
 *   "download_url": "https://popisite.cz/downloads/popi-landing-page-1.0.1.zip",
 *   "requires": "6.2",
 *   "requires_php": "7.4",
 *   "tested": "6.7",
...
class Popi_Landing_Updater {
	...
	public function __construct( $plugin_file, $update_url, $current_version ) {
		$this->plugin_slug     = 'popi-landing-page';
	...
	public function check_update( $transient ) {
		...
		if ( version_compare( $this->current_version, $remote->version, '<' ) ) {
			$transient->response[ $this->plugin_basename ] = (object) array(
				...
				'url'          => 'https://popisite.cz/plugins/popi-landing-page/',
	...
	private function fetch_remote_data() {
		$transient_key = 'popi_landing_update_data';
