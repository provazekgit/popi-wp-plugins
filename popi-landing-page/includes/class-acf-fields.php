		...
		acf_add_local_field_group( array(
			...
			'fields'          => array(
				array_merge( self::d_text(), array(
					...
					'default_value' => Popi_Landing_Settings::get( 'price_individual' ),
					'placeholder'   => '250 Kč',
				) ),
				array_merge( self::d_text(), array(
					...
					'default_value' => Popi_Landing_Settings::get( 'price_child' ),
					'placeholder'   => '150 Kč',
				) ),
				array_merge( self::d_text(), array(
					...
					'default_value' => Popi_Landing_Settings::get( 'price_family' ),
					'placeholder'   => '690 Kč',
				) ),
				array_merge( self::d_text(), array(
					'key'           => 'field_popi_price_senior',
					'label'         => 'Cena — senior',
					'name'          => 'popi_lp_price_senior',
					'default_value' => Popi_Landing_Settings::get( 'price_senior' ),
					'placeholder'   => '200 Kč',
				) ),
				array_merge( self::d_text(), array(
					...
					'default_value' => Popi_Landing_Settings::get( 'price_group' ),
					'placeholder'   => '200 Kč/osoba',
					'instructions'  => 'Nepovinné — ponech prázdné, pokud daná kategorie pro tuto LP nedává smysl. Použije se v ceníkové tabulce ([popi_lp_pricing]) i ve Schema.org datech (Google rich results). Výchozí hodnoty jdou předvyplnit v podmenu Výchozí hodnoty.',
				) ),
			),
			'location'        => array( array( array( 'param' => 'post_type', 'operator' => '==', 'value' => 'popi_landing' ) ) ),
			'position'        => 'normal',
